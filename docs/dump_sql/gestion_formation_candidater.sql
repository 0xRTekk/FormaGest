...
CREATE TABLE `candidater` (
  ...
  CONSTRAINT `candidater_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `session` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `candidater_ibfk_2` FOREIGN KEY (`participant_id`) REFERENCES `participant` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `candidater` VALUES (30,3,1,NULL);
